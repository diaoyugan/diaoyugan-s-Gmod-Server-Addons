...
function GM:PlayerLoadout(ply)
	...
	ply:Give("weapon_ct_fists")
	ply:Give("weapon_ct_medkit")
	ply:Give("weapon_ct_toy")
...
function GM:DoPlayerDeath( ply, attacker, dmginfo )
    ...
    local deathbox = ents.Create( "prop_physics" )
    deathbox:SetModel( "models/death_box_01/death_box_01.mdl" )
